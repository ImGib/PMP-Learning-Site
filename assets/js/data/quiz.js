...
{ cat: "Finance", q: "Cuối tuần 2: kế hoạch xong 2 giai đoạn ($500/giai đoạn), thực tế xong 3 giai đoạn, đã chi $1700. EV bằng bao nhiêu?", opts: ["$1000", "$1500", "$1700", "$2000"], correct: 1, expl: "EV = giá trị (theo kế hoạch) của công việc ĐÃ HOÀN THÀNH = 3 × 500 = 1500. PV=1000 (2 giai đoạn), AC=1700." },
{ cat: "Finance", q: "Với EV=1500, PV=1000, AC=1700: SV và CV là bao nhiêu?", opts: ["SV=+500, CV=-200", "SV=-200, CV=+500", "SV=+500, CV=+200", "SV=-500, CV=-200"], correct: 0, expl: "SV=EV-PV=1500-1000=+500 (nhanh hơn). CV=EV-AC=1500-1700=-200 (vượt chi)." },
{ cat: "Finance", q: "Dự án BAC=$100k, EV=$40k, AC=$50k, sai lệch được cho là điển hình. EAC bằng bao nhiêu?", opts: ["$110k", "$125k", "$90k", "$100k"], correct: 1, expl: "Sai lệch điển hình: EAC=BAC/CPI. CPI=EV/AC=40/50=0.8. EAC=100/0.8=125k." },
{ cat: "Finance", q: "Loại dự phòng nào cho rủi ro CHƯA BIẾT và nằm NGOÀI cost baseline?", opts: ["Contingency reserve", "Management reserve", "Cost baseline", "Control account"], correct: 1, expl: "Management reserve = unknown-unknowns, ngoài baseline, cần approval để đưa vào. Contingency = known risks, trong baseline." },
{ cat: "Finance", q: "Ước tính ROM ở giai đoạn khởi tạo thường có khoảng nào?", opts: ["-5% đến +10%", "-10% đến +25%", "-25% đến +75%", "0% đến +100%"], correct: 2, expl: "ROM: -25% đến +75%. Definitive: -5/+10. Chi tiết dần khi dự án tiến triển." },
{ cat: "Risk", q: "Cược: rút được lá cơ thắng $200, ngược lại mất $100. EMV bằng bao nhiêu?", opts: ["+$50", "-$25", "+$25", "-$75"], correct: 1, expl: "Cơ: 0.25 × 200 = +50; khác: 0.75 × (-100) = -75; EMV = 50-75 = -25. Kỳ vọng âm → không nên chơi." },
{ cat: "Risk", q: "Một rủi ro nằm ngoài phạm vi dự án và vượt thẩm quyền PM. Phản ứng tốt nhất?", opts: ["Mitigate", "Accept", "Escalate", "Transfer"], correct: 2, expl: "Escalate khi vượt quyền PM / ngoài scope. Sau escalate team không theo dõi tiếp (chỉ ghi nhận)." },
{ cat: "Risk", q: "Mua bảo hiểm để phòng một threat là chiến lược nào?", opts: ["Avoid", "Mitigate", "Transfer", "Accept"], correct: 2, expl: "Transfer = chuyển impact + ownership cho bên thứ ba (bảo hiểm, bảo hành, fixed-price). Không loại bỏ risk, chỉ chuyển gánh nặng." },
{ cat: "Risk", q: "Một rủi ro MỚI phát sinh trực tiếp TỪ việc thực thi một response được gọi là?", opts: ["Residual risk", "Secondary risk", "Fallback risk", "Overall risk"], correct: 1, expl: "Secondary risk = do response sinh ra. Residual = còn lại sau khi xử lý." },
{ cat: "Risk", q: "Chiến lược nào làm một CƠ HỘI chắc chắn xảy ra (xác suất ~100%)?", opts: ["Enhance", "Share", "Exploit", "Accept"], correct: 2, expl: "Exploit = đảm bảo cơ hội chắc chắn xảy ra. Enhance chỉ tăng xác suất/impact; Share hợp tác bên khác." },
{ cat: "Risk", q: "Process nào mô hình hóa tác động rủi ro tổng hợp bằng mô phỏng Monte Carlo?", opts: ["Identify Risks", "Perform Qualitative Risk Analysis", "Perform Quantitative Risk Analysis", "Plan Risk Responses"], correct: 2, expl: "Monte Carlo / EMV / decision tree / sensitivity thuộc Quantitative. Qualitative chỉ là P-I matrix chủ quan." },
{ cat: "Risk", q: "Process nào diễn ra ĐẦU TIÊN trong quản lý rủi ro?", opts: ["Plan Risk Responses", "Perform Qualitative Risk Analysis", "Plan Risk Management", "Monitor Risks"], correct: 2, expl: "Thứ tự: Plan Risk Management → Identify → Qualitative → Quantitative → Plan Responses → Implement → Monitor." },
{ cat: "Schedule", q: "Đường găng A-B-C = 14 ngày; đường A-D-C = 12 ngày. Total float của activity D là?", opts: ["0 ngày", "2 ngày", "12 ngày", "14 ngày"], correct: 1, expl: "Float = đường găng - đường có D = 14-12 = 2. Activity trên đường găng có float 0." },
{ cat: "Schedule", q: "Cho O=10, M=20, P=60 ngày, ước lượng Beta (PERT) là?", opts: ["30", "25", "22", "20"], correct: 1, expl: "Beta E=(O+4M+P)/6=(10+80+60)/6=150/6=25. (Triangular sẽ là (10+20+60)/3=30)." },
{ cat: "Schedule", q: "Làm song song các việc tuần tự trên đường găng để nén lịch là?", opts: ["Crashing", "Fast tracking", "Resource leveling", "Resource smoothing"], correct: 1, expl: "Fast tracking = làm song song, tăng rủi ro/rework, không tăng chi phí trực tiếp. Crashing = thêm nguồn lực, tăng chi phí." },
{ cat: "Schedule", q: "Kỹ thuật tối ưu nguồn lực nào CÓ THỂ đổi đường găng và ngày kết thúc?", opts: ["Resource smoothing", "Resource leveling", "Fast tracking", "Bottom-up estimating"], correct: 1, expl: "Leveling có thể đổi đường găng / trễ ngày kết thúc. Smoothing chỉ trong float, không đổi." },
{ cat: "Schedule", q: "Free float chỉ xuất hiện khi...", opts: ["Activity nằm trên đường găng", "Hai hoặc nhiều activity chung một successor", "Dự án có float âm", "Activity có duration bằng 0"], correct: 1, expl: "Free float = trễ không trễ early start của successor; chỉ xuất hiện khi nhiều activity chung một successor." },
{ cat: "Schedule", q: "Milestone nên được gán duration bằng bao nhiêu?", opts: ["1 ngày", "Bằng 0", "Bằng work package", "Tùy nguồn lực"], correct: 1, expl: "Milestone = một thời điểm, duration = 0. Đánh dấu hoàn thành deliverable/sự kiện quan trọng." },
{ cat: "Schedule", q: "Kỹ thuật ước lượng nào thường CHÍNH XÁC NHẤT nhưng tốn thời gian nhất?", opts: ["Analogous", "Parametric", "Bottom-up", "Expert judgment"], correct: 2, expl: "Bottom-up chi tiết nhất → chính xác nhất nhưng tốn thời gian/chi phí. Analogous (top-down) nhanh nhưng kém chính xác." },
{ cat: "Quality", q: "Control chart có 7 điểm liên tiếp dưới đường trung bình, đều trong control limits. Điều này cho thấy?", opts: ["Process ổn định", "Process ngoài kiểm soát (rule of seven)", "Đã vượt specification limits", "Dữ liệu không hợp lệ"], correct: 1, expl: "Rule of seven: 7 điểm liên tiếp cùng phía trung bình = out of control dù vẫn trong control limit → cần điều tra (assignable cause)." },
{ cat: "Quality", q: "Rework và phế phẩm do đội dự án phát hiện là loại chi phí chất lượng nào?", opts: ["Prevention costs", "Appraisal costs", "Internal failure costs", "External failure costs"], correct: 2, expl: "Lỗi tìm thấy bởi DỰ ÁN (trước giao) = internal failure. Lỗi tìm thấy bởi KHÁCH HÀNG = external (warranty, mất khách)." },
{ cat: "Quality", q: "Ai đặt ra specification limits trên control chart?", opts: ["Đội dự án dựa trên năng lực process", "Khách hàng / yêu cầu hợp đồng", "QA auditor", "Sponsor dựa trên khẩu vị rủi ro"], correct: 1, expl: "Spec limits từ khách hàng/hợp đồng. Control limits từ chính process (voice of the process), thường +/-3 sigma." },
{ cat: "Quality", q: "Control Quality tạo ra output nào?", opts: ["Accepted deliverables", "Verified deliverables", "Sản phẩm cuối", "Change log"], correct: 1, expl: "QC → verified deliverables (kiểm tra nội bộ). Validate Scope → accepted deliverables (khách hàng nghiệm thu chính thức)." },
{ cat: "Quality", q: "Process nào mang tính phòng ngừa, hướng process và trải suốt vòng đời?", opts: ["Control Quality", "Manage Quality (QA)", "Validate Scope", "Inspection"], correct: 1, expl: "QA/Manage Quality = phòng ngừa, hướng process, cả vòng đời. QC = corrective, hướng product, phần testing." },
{ cat: "Quality", q: "Xe Toyota rẻ hơn Rolls Royce nhưng ít lỗi. Theo PMBOK, Toyota có...", opts: ["Chất lượng thấp, hạng thấp", "Chất lượng cao, hạng thấp", "Chất lượng thấp, hạng cao", "Chất lượng cao, hạng cao"], correct: 1, expl: "Ít lỗi = chất lượng cao; ít tính năng/hạng thấp hơn = low grade. Low quality luôn là vấn đề, low grade thì không." },
{ cat: "Quality", q: "Công cụ nào theo nguyên lý 80/20 để ưu tiên nhóm nguyên nhân trọng yếu?", opts: ["Histogram", "Pareto chart", "Scatter diagram", "Control chart"], correct: 1, expl: "Pareto = 80% vấn đề từ 20% nguyên nhân; tách 'critical few'. Fishbone tìm root cause chứ không xếp hạng." },
{ cat: "Procurement", q: "Loại hợp đồng nào đặt RỦI RO CHI PHÍ nhiều nhất lên seller?", opts: ["CPFF", "T&M", "FFP", "CPIF"], correct: 2, expl: "FFP: giá cố định, seller gánh mọi chi phí vượt → rủi ro seller cao nhất. CPFF: buyer hoàn chi phí → rủi ro buyer cao." },
{ cat: "Stakeholder", q: "Mô hình phân loại stakeholder theo power, urgency và legitimacy là?", opts: ["Power/Interest grid", "Salience model", "RACI chart", "Stakeholder cube"], correct: 1, expl: "Salience model = Power + Urgency + Legitimacy (3 chiều). Power/Interest grid chỉ 2 chiều." },
{ cat: "Resource", q: "Theo Herzberg, yếu tố nào KHÔNG tạo động lực bền vững (chỉ là hygiene)?", opts: ["Sự ghi nhận", "Lương & điều kiện làm việc", "Cơ hội phát triển", "Trách nhiệm"], correct: 1, expl: "Lương, điều kiện làm việc là hygiene — thiếu thì bất mãn, có cũng không tạo động lực bền. Motivator: ghi nhận, phát triển, trách nhiệm." },
{ cat: "Agile", q: "Checklist áp dụng cho MỌI hạng mục, phải đạt trước khi increment 'done' là?", opts: ["Acceptance criteria", "Definition of Done", "Product backlog", "Sprint goal"], correct: 1, expl: "DoD = tiêu chuẩn chung mọi story (đã test, review, tích hợp). Acceptance criteria = điều kiện riêng từng story." }
];
